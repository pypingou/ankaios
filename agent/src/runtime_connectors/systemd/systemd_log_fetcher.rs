...
use super::SystemdWorkloadId;
use crate::runtime_connectors::{runtime_connector::LogRequestOptions, RuntimeError};
...
impl SystemdLogFetcher {
    pub fn new(
        ...
        args.push("-u");
        args.push(&workload_id.unit_name);
...
mod tests {
    ...
    use crate::runtime_connectors::{
        log_fetcher::GetOutputStreams, systemd::SystemdWorkloadId, LogRequestOptions,
    };
